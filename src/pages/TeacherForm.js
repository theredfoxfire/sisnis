...
export default class TeacherForm extends Component {
            ...
            <Segment stacked>
              ...
              <Form.Input
                ...
                onChange={(e) =>
                  this.setState({
                    ...
                    name: name || selectedTeacher.name,
                  })
                }
              />
              <h4>Nama Guru:</h4>
              <Form.Input
                ...
                onChange={(e) =>
                  this.setState({
                    name: e.target.value,
                    serial: serial || selectedTeacher.serial,
                  })
                }
              />
              <Link to={"/teacher"}>
              ...
              <Link
                to={name !== "" ? "/teacher" : `/teacher-form/${teacherID}`}
              >
                <Button
                  color="teal"
                  size="small"
  ...
  _handleSubmit = () => {
    ...
    let teacherID = this.props.match.params.id;
    teacherID > 0
      ? putTeacher({ name: name, serial: serial }, teacherID)
      : postTeacher({ name: name, serial: serial });
  };
