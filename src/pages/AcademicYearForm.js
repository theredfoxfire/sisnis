...
class AcademicYearForm extends Component {
          ...
          <Form size="large">
            <Segment stacked>
              ...
              <Form.Input
                ...
                onChange={(e) =>
                  this.setState({ year: e.target.value, scale: isActiveValue })
                }
              />
              <h4>Status</h4>
              <DropdownSelect
                ...
                value={isActiveValue}
                onChange={(e, { value }) =>
                  this.setState({ year: yearValue, isActive: value })
                }
                multiple={false}
              ...
              <Link
                to={
                  year !== ""
                    ? "/academic-year"
                    : `/academic-year-form/${academicYearID}`
                }
              >
                <Button
                  color="teal"
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (
      JSON.stringify(prevProps.selectedAcademicYear) !==
  ...
  _handleSubmit = () => {
    ...
    let academicYearID = this.props.match.params.id;
    academicYearID > 0
      ? putAcademicYear({ year, isActive }, academicYearID)
      : postAcademicYear({ year, isActive });
  };
