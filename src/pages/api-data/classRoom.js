...
export function deleteClass(id) {
  axiosWorker
    .delete(`api/class-room/delete/${id}`)
    .then((res) => {
      storeActions.setIsLoading(false);
      getClassRoomList();
    })
...
export function deleteStudentClass(id) {
  return axiosWorker
    .delete(`api/student/delete/class/${id}`)
    .then((res) => {
      storeActions.setIsLoading(false);
    })
    .catch(function (error) {
