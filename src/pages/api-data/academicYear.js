...
export function getAcademicYearsList() {
  axiosWorker.get(`api/academic_year/get-all`)
    .then(res => {
...
export function getAcademicYearByID(id) {
  axiosWorker.get(`api/academic_year/get/${id}`)
    .then(res => {
...
export function postAcademicYear(formData) {
  axiosWorker.post(`api/academic_year/add`, {
    ...formData
  })
...
export function putAcademicYear(formData, id) {
  axiosWorker.put(`api/academic_year/update/${id}`, {
    ...formData,
  })
  .then(function (response) {
    storeActions.setIsLoading(false);
...
export function deleteAcademicYear(id) {
  return axiosWorker.delete(`api/academic_year/delete/${id}`)
    .then(res => {
      storeActions.setIsLoading(false);
      getAcademicYearsList();
    }).catch(function (error) {
