        ...
        return (
            <Grid centered>
                <Grid.Column mobile={16} tablet={12} computer={8}>
                    <Card fluid>
                        <Card.Content>
                            <Card.Header>Rekap Absesnsi Siswa</Card.Header>
                    ...
                    <Table celled selectable>
                        <Table.Header>
                            <Table.Row>
                                ...
                                <Table.HeaderCell>Hadir</Table.HeaderCell>
                                <Table.HeaderCell>Ijin</Table.HeaderCell>
                                <Table.HeaderCell>Sakit</Table.HeaderCell>
...
export default chainToView(TeacherAttendanceReport);
